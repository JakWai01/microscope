...
df = pd.DataFrame(
    {
        "benchmark": names,
        "Qiskit 2.1.0rc1": preview_data,
        "Qiskit 2.0.2": release_data,
        "Runtime ratio (2.0.2 / 2.1.0rc1)": ratios,
    }
)
# print(df)
sns.set()
...
ax1.set_title(
    "Qiskit 2.0.2 vs 2.1.0rc1 runtime ratio for benchpress transpile benchmarks"
)
plt.tight_layout()
