...
input_files = glob.glob(
    "/home/jakob/Documents/Projects/microscope/assets/benchmark/test-k3-1h-norm/combined/*"
)
...
for path in input_files:
    ...
    for bench in data.get("benchmarks", []):
        swaps = (
            bench.get("extra_info", {}).get("output_circuit_operations", {}).get("swap")
        )
...
# Write to file
output_path = "/home/jakob/Documents/Projects/microscope/assets/benchmark/test-k3-1h-norm/stats/benchmark_swap_stats.json"
with open(output_path, "wb") as f:
    f.write(orjson.dumps(aggregated, option=orjson.OPT_INDENT_2))

print(
    f"Wrote aggregated swap stats for {len(aggregated['benchmarks'])} benchmarks to {output_path}"
)
